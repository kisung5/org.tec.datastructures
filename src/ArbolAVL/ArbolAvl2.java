...
//
///**
// * Implementa métodos de AbstractCollection y AbstractSet de forma específica
// * para una estructura de arbol AVL, mejorando en ciertos casos la velocidad de
// * ejecucion.
// *
...
//
//	/**
//	 * Constructor para recibir el comparador que se utilizará para comparar los
//	 * elementos. Si no se construye el árbol con este método los objetos se
//	 * compararan en función del orden natural (comparable).
//	 * 
//	 * @param cmp
//	 *            comparador
//	 */
...
//	 * element after this call returns. This implementation always throws an
...
//
//	/**
//	 * Estructura el arbol haciendo las rotaciones necesarias. Rotacion simple
//	 * derecha, rotacion compuesta derecha izquierda, rotacion simple izquierda y
//	 * rotacion compuesta izquierda derecha.
//	 * 
//	 * @param nodo
//	 *            nodo con factor de equilibro 2.
//	 * @param altIzq
//	 *            altura izquierda del nodo pasado por parametro.
//	 * @param altDer
//	 *            altura derecha del nodo pasado por parametro.
//	 *
...
//	 * 
//	 * @param nodo
//	 *            nodo del que se desea extraer el factor de equilibrio.
//	 * 
...
//
//	/**
//	 * Realiza la operacion de rotacion simple derecha en el subarbol . que tiene
//	 * como raiz el nodo pasado por parametro.
//	 * 
//	 * @param nodo
//	 *            raiz del subarbol a rotar.
...
//
//	/**
//	 * Indica si el arbol o subarbol cuya raiz es es el nodo pasado por parametro es
//	 * un arbol equilibrado o no.
//	 * 
//	 * @param n
//	 *            raiz del subarbol o arbol .
//	 *
...
//
//	/**
//	 * Obtiene el nodo padre del nodo pasado por parametro. En caso de que no tenga
//	 * padre, devuelve el mismo nodo pasado por parametro.
//	 *
//	 * @param nodo
//	 *            nodo del que se quiere obtener su nodo padre.
//	 * @return nodo padre.
//	 */
...
//	 * collection is this collection, and this collection is nonempty.) This
//	 * implementation iterates over the specified collection, and adds each object
//	 * returned by the iterator to this collection, in turn. Note that this
//	 * implementation will throw an UnsupportedOperationException unless add is
...
//		// el arbol ya existía
//		else {
//			// comprobamos que los datos sean comparables con los que ya están dentro del
//			// arbol
...
//	 * collection will be empty after this method returns. This implementation
//	 * iterates over this collection, removing each element using the
//	 * Iterator.remove operation. Most implementations will probably choose to
//	 * override this method for efficiency. Note that this implementation will throw
...
//	 * element e such that (o==null ? e==null : o.equals(e)). This implementation
//	 * iterates over the elements in the collection, checking each element in turn
...
//	 * call). This implementation iterates over the collection looking for the
...
//	 * iterator's remove method. Note that this implementation will throw an
//	 * UnsupportedOperationException if the iterator returned by the iterator method
//	 * does not implement the remove method and this collection contains one or more
//	 * elements in common with the specified collection.
//	 *
//	 * @param c
...
//
//	/**
//	 * Este método recorre el árbol mediante el recorrido INORDEN y almacena cada
...
//	 * 
//	 * @param dato
//	 *            dato del que buscamos la altura.
...
//	 * parámetro, si eldato no se encuentra en el árbol se devuelve -1. La
//	 * profundidad del nodo raíz es 0.
//	 * 
//	 * @param dato
//	 *            dato del que buscamos su profundidad.
...
//	 * 
//	 * @param nodo
//	 *            nodo del que buscamos extraer el el nodo.
//	 * @return dato
//	 */
...
//
//	/**
//	 * Funcion que compara mediante un modo u otro dependiendo de si el objeto que
//	 * se pasa por parametro es comparable o necesita de una funcion especifica.
//	 * 
//	 * @param t1
//	 *            dato1
//	 * @param t2
...
//		 * 
//		 * @param fe
//		 *            factor de equilibro para asignar al nodo.
//		 */
